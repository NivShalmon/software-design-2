...
public class BuyProductReaderTest {
    ...
    public void productOrderedAndThenCancelledShouldHaveNoItemsPurchased() throws Exception {
        setUp("ourData.json");
        BuyProductReader reader = injector.getInstance(BuyProductReader.class);
        Assert.assertEquals(OptionalLong.empty(),reader.getTotalNumberOfItemsPurchased("nokia").get());
        Assert.assertEquals(OptionalDouble.empty(),reader.getAverageNumberOfItemsPurchased("nokia").get());
    }
    @Test
    public void productOrderedOnceAndThenOverriddenWithAnotherProductShouldHaveNoItemsPurchased() throws Exception {
        setUp("ourData.json");
        BuyProductReader reader = injector.getInstance(BuyProductReader.class);
        Assert.assertEquals(OptionalLong.empty(),reader.getTotalNumberOfItemsPurchased("idroid").get());
        Assert.assertEquals(OptionalDouble.empty(),reader.getAverageNumberOfItemsPurchased("idroid").get());
    ...
    public void productNeverOrderedShouldHaveNoItemsPurchased() throws Exception {
        setUp("ourData.json");
        BuyProductReader reader = injector.getInstance(BuyProductReader.class);
        Assert.assertEquals(OptionalLong.empty(),reader.getTotalNumberOfItemsPurchased("mac").get());
        Assert.assertEquals(OptionalDouble.empty(),reader.getAverageNumberOfItemsPurchased("mac").get());
    }
    @Test
